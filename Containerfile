# Based on frappe/frappe_docker images/layered/Containerfile.
# Keep the runtime package layer explicit: app pyproject apt declarations are
# not installed by the upstream layered image build.
